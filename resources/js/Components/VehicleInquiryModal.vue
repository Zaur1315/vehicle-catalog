...
<template>
    <Teleport to="body">
        <Transition name="inquiry-modal">
            <div v-if="open" class="inquiry-modal-backdrop" @click.self="close">
                <section
                    ref="modal"
                    class="inquiry-modal"
                    role="dialog"
                ...
                >
                    <header class="inquiry-modal-header">
                        <div>
                            <p class="eyebrow">Vehicle inquiry</p>
                            <h2
                    ...
                    <div v-if="success" class="inquiry-success">
                        <p class="eyebrow">Request received</p>
                        <h3 class="mt-2 text-xl font-bold">
                            Thanks for reaching out.
                        </h3>
                        <p class="mt-2 text-sm leading-6 text-text-muted">
                            Our sales team will review your request and contact
                            you soon.
                        </p>
                        <button
                            type="button"
                    ...
                    >
                        ...
                        <label>
                            ...
                            />
                            <p
                                v-if="form.errors.preferred_contact_time"
                                class="form-error"
                            >
