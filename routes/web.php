...
Route::permanentRedirect('/delivery', '/contact')->name('delivery');

Route::permanentRedirect('/warranty-return', '/contact')->name('warranty-return');

Route::get('/about', AboutController::class)->name('about');

Route::permanentRedirect('/service', '/contact')->name('service');
