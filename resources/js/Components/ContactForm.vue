...
onMounted(() => {
    ...
    if (subject && props.topics.some((topic) => topic[0] === subject))
...
<template>
    <div v-if="submitted" class="py-8" role="status">
        ...
        <p class="mt-4 leading-7 text-text-muted">
            Our team will contact you soon about your message.
        </p>
        <button
            type="button"
    ...
    <form v-else @submit.prevent="submit">
        ...
        <h3 class="mt-3 text-2xl font-bold">How can we help?</h3>
        ...
        <label class="mt-4 block">
            ...
            <select v-model="form.subject" class="form-select-dark">
        ...
        <p class="form-help">
            By submitting this form, you’re asking {{ page.props.site.name }} to
